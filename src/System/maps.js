module.exports = {
	phpRestartCommand: function ( phpVersion, webServer ) {
		const map = {
			'apache': {
		...
		return map.hasOwnProperty( webServer ) && map[webServer].hasOwnProperty( phpVersion ) ?
			map[webServer][phpVersion]
			: false
	},
