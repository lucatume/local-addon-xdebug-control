		...
		_createClass(FieldsList, [{
			...
			value: function render() {
				return React.createElement(
					...
					React.createElement(OptionField, { title: 'remote_enable', name: 'remote_enable', value: this.state.remote_enable, options: props.toggleOptions }),
					React.createElement(OptionField, { title: 'remote_host', name: 'remote_host', value: this.state.remote_host, options: props.remoteHostOptions }),
					React.createElement(OptionField, { title: 'remote_port', name: 'remote_port', value: this.state.remote_port, options: props.remotePortOptions }),
					React.createElement(OptionField, { title: 'remote_autostart', name: 'remote_autostart', value: this.state.remote_autostart, options: props.toggleOptions }),
					...
					React.createElement(OptionField, { title: 'scream', name: 'scream', value: this.state.scream, options: props.toggleOptions }),
					React.createElement(OptionField, { title: 'show_local_vars', name: 'show_local_vars', value: this.state.show_local_vars, options: props.toggleOptions }),
