...
module.exports = function (context) {
	...
	return function FieldList(props) {
		...
		return React.createElement(
			...
			React.createElement(
				'ul',
				{ className: 'TableList Form FieldList', style: Object.assign({ maxWidth: '600px', marginBottom: '.5em' }, props.style) },
				options
			),
			React.createElement(Button, { text: 'Apply Settings', className: 'FieldList__Apply', onClick: applyWith, centered: true })
		);
	};
};